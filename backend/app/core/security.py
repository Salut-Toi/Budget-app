...
# -------------------------------------------------------------
# 💡 Correction : utilisation de PBKDF2-SHA256 (pas de bug bcrypt)
# -------------------------------------------------------------
pwd_context = CryptContext(schemes=["pbkdf2_sha256"], deprecated="auto")

# Authentification OAuth2 (login → /api/v1/auth/login)
...
# -------------------------------------------------------------
# Fonctions de hachage / vérification de mot de passe
# -------------------------------------------------------------
def verify_password(plain: str, hashed: str) -> bool:
    """Vérifie qu’un mot de passe brut correspond à son hash."""
